  ...
  <div id="colorlib-page">
    ...
    <aside id="colorlib-aside" role="complementary" class="border js-fullheight">
      ...
      <div class="colorlib-footer">
        <a href="login.php" style="color: grey;">Log In</a>
                    ...
                    <div id="hasil">
                      <table class="table table-striped">
                        ...
                        while ($row = $result->fetch_object()) {
                          ...
                          echo '<td>' . '<a href="book.php"><img src="' . $image . '" width="100">' . '</a></td>';
                          echo '<td>' . $row->isbn . '</td>';
          ...
          <div class="row">
            <div class="col-md-6 col-sm-6 animate-box" data-animate-effect="fadeInLeft">
              <div class="blog-entry">
                <a href="blog.html#blog1" class="blog-img"><img src="images/percyjackson.jpg" class="img-responsive" alt="picture"></a>
                <div class="desc">
            ...
            <div class="col-md-6 col-sm-6 animate-box" data-animate-effect="fadeInLeft">
              <div class="blog-entry">
                <a href="blog.html#blog2" class="blog-img"><img src="images/sherlockholmes.jpeg" class="img-responsive" alt="picture"></a>
                <div class="desc">
