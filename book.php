    ...
    <aside id="colorlib-aside" role="complementary" class="border js-fullheight">
      ...
      <nav id="colorlib-main-menu" role="navigation">
        <ul>
          ...
          <li class="colorlib-active"><a href="book.php">Book</a></li>
        ...
        <div class="colorlib-narrow-content">
          ...
          <div class="tabel">
            ...
            while ($row2 = $result2->fetch_object()) {
              ...
              // require_once('koneksi.php');
              $query = "SELECT * FROM buku WHERE idkategori = $row2->idkategori";
              ...
              while ($row = $result->fetch_object()) {
                ...
                if ($row->stok_tersedia != 0) {
                  ...
                  echo '<h5 class="st"><b>Stok: ' . $row->stok_tersedia . '</b></h5>';
                  echo '<a href="login.php?buku=' . $row->idbuku . '" class="button">Pinjam Sekarang</a>';
                } else {
                  echo '<div class = "project">';
                  ...
                  echo '<h3><a>' . $row->judul . '</a></h3>';
                  echo '<p class="icon">' . $row->sinopsis . '</p>';
                  echo '<h4 class="text-danger"><b>Stok Kosong</b></h4>';
                }
                echo '</div>';
                echo '</div>';
                echo '</div>';
